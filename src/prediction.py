...
class PredictionInterface:
    ...
    def predict_match_outcome(self, player1_name: str, player2_name: str, 
        ...
        """
        Predict match outcome using the AVERAGING TRICK to eliminate naming bias:
        ...
        if model in ['xgb', 'both'] and model in ['rf', 'both']:
            ...
            predictions['bias_check'] = {
                'xgboost_bias': xgb_bias,
                'random_forest_bias': rf_bias,
